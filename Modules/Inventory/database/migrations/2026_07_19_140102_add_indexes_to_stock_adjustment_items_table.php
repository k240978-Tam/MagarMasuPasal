...
return new class extends Migration
{
     ...
     * beyond the primary key, so listing an adjustment's lines or a
     * product's adjustment history across a business would scan the
     * whole table on MySQL.
     */
    ...
    {
        Schema::table('stock_adjustment_items', function (Blueprint $table) {
            $table->dropIndex(['business_id', 'stock_adjustment_id']);
